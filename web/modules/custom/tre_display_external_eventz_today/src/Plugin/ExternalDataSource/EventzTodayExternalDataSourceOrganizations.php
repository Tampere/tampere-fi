...
/**
 * Class for getting organizations from Eventz.Today Events API.
 *
 * @ExternalDataSource(
 *  id = "eventz_today_external_data_source_organizations",
 *  name = @Translation("Organizations classes from Eventz.Today external data source"),
 *  description = @Translation("Organizations classes from Eventz.Today external data source"),
 * )
 */
class EventzTodayExternalDataSourceOrganizations extends EventzTodayExternalDataSourcePluginBase {

  /**
   * {@inheritdoc}
   */
  public function getPluginId() {
    return 'eventz_today_external_data_source_org_classes';
  }
